# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-09-19 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ngayKhoiTao', models.DateField(default=datetime.date(2017, 9, 19))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kitchenrock_api.CongThucMonAn')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ngayTao', models.DateField(default=datetime.datetime(2017, 9, 19, 14, 20, 51, 658503, tzinfo=utc))),
                ('ctma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kitchenrock_api.CongThucMonAn')),
                ('taikhoan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='congthucmonan',
            name='theloai',
            field=models.ManyToManyField(db_table='kitchenrock_theloaicongthuc', to='kitchenrock_api.TheLoai'),
        ),
        migrations.AddField(
            model_name='congthucmonan',
            name='user',
            field=models.ManyToManyField(db_table='kitchenrock_congthucyeuthich', to=settings.AUTH_USER_MODEL),
        ),
